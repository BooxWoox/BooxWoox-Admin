...
import DelayedBorrowers from '../apis/LateReturnDelayed.json'
import Borrowers from '../apis/InTransaction.json'
      ...
      <div className="Container">
        <div className="Tabs">
          <p
            ...
            onClick={() => setDelayedBorrowers()}
          >
            {tabNames[0]}
          </p>
          <p
            id={activeTab === 1 ? 'activeTab' : ''}
            onClick={() => setInTransactionBorrowers()}
          >
            {tabNames[1]}
          </p>
        </div>
